...
def test_other_civic_routes_to_local_government() -> None:
    assert route_categories([Category.OTHER_CIVIC]) == [AgencyType.LOCAL_GOV]
...
def test_report_track_is_derived_with_emergency_priority() -> None:
    ...
    assert derive_report_track([Category.OTHER_CIVIC]) is ReportTrack.CIVIC
